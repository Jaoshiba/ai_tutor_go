...
// 	RoadMapRepo repo.IcourseRepository
// }

// type IRoadmapService interface {
// 	CreateRoadmap(roadmapJsonBody entities.CourseRequestBody, file *multipart.FileHeader, callFromRoadmap bool, ctx *fiber.Ctx) error //add userId ด้วย
// }

// func NewRoadmapService(roadMapRepo repo.IcourseRepository) IRoadmapService {
// 	return &roadMapService{
// 		RoadMapRepo: roadMapRepo,
// 	}
// }

// func (rs *roadMapService) CreateRoadmap(roadmapJsonBody entities.CourseRequestBody, file *multipart.FileHeader, callFromRoadmap bool, ctx *fiber.Ctx) error {

// 	if callFromRoadmap {
// 		//get content from additional file
// 		courseName := roadmapJsonBody.
